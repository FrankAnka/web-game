...
var inventory = {81:{"type":"hoe","count":1},82:{"type":"watering can","count":1},84:{"type":"thorneye seeds","count":3}}
var money = 100
var max_stack = 999
var held_item = null
var inv_active = true
...
@export var tier_req = {1:{1:{"type":"thorneye","count":10},2:{"type":"shadevine","count":8}},2:{1:{"type":"duskbell","count":25}},3:{}} # with the required items to be sold to advance to a higher tier, formatted as tier:{"itemname:"amount,}
var current_tier = 0
var cur_tier_sold = {}
